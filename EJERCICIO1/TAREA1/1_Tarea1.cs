...
namespace Tarea11
{
	...
	class Program
	{
		...
		static void Main(string[] args)
		{
			...
			int N_PACIENTES = 4;
			int DuracionConsulta = 10;
			Random rnd = new Random();
			for (int i = 0;i < N_PACIENTES; i++)
			{
				CM.LlegadaPaciente(new Paciente(i + 1, i + 1, DuracionConsulta),(Prioridad)rnd.Next(0,2));
    ...
    public class CentroMedico
	{
		...
		{	
			...
			bloqueo = false;
			Console.WriteLine("" + DateTime.Now.ToString() + ":" + " Llegada paciente" + paciente.Id + " al centro médico");
		}
